...
//    });
    return Container(
      child: FutureBuilder(
        future: course.getProfiles(course, Provider.of<Auth>(context, listen: false).token),
            ...
            child: ListTile(
              ...
              trailing: CircleAvatar(
                backgroundImage: AssetImage(
                  snapshot.data[index]['picture'] == null ? 'assets/images/avatar.png' : 'assets/images/user.png',
                ),
              ),
            )
          ),
